...
const FIRMA_BY_EMPRESA: Record<Emp, string> = {
  11: 'assets/firma_emp11.png',
};

const FIRMA_FALLBACK = 'assets/firma.png';

@Injectable()
export class PdfServiciosService11 {
  constructor(private readonly html: HtmlPdfServiciosService11) { }
  ...
  private brandByEmpresa(empresa: Emp) {
    const map: Record<Emp, { color: string; logo: string }> = {
      11: { color: '#0A59BF', logo: '../assets/emp11.png' },
    };
    return map[empresa];
  }
