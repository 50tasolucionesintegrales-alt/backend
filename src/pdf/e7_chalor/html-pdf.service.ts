...
function calculateFooterLines(condiciones?: string): number {
    ...
    const condicionesLines = calculateTextLines(condiciones, 52);
...
hbs.registerHelper('smartChunk_e7', function(items: any[], options: any) {
...
hbs.registerHelper('needsSeparateImportantPage_e7', function(items: any[], options: any) {
    ...
    const chunks = hbs.helpers.smartChunk_e7(items, options);
