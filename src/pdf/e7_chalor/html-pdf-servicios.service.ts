...
// Helper para calcular paginación inteligente con división de items largos - SERVICIOS E7
...
// Helper para saber si necesita página separada para info importante - SERVICIOS E7
hbs.registerHelper('needsSeparatePageServicios7', function(items: any[]) {
    ...
    // ✅ MENOS RESTRICTIVO: Solo saltar si realmente no cabe
    if (lastPageLines > 18) return true;  // Aumentado de 15 a 18
    
    // Calcular espacio con margen de seguridad reducido
    const totalPageCapacity = isFirstPage ? 50 : 55;
    const spaceNeeded = totalLinesOnLastPage + FOOTER_LINES;
    const SAFETY_MARGIN = 2;  // Reducido de 4 a 2
